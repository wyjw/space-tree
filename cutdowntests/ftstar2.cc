...
static void test_serialize_nonleaf_two(int valsize,
    ...
    tbl.next_head = {.b = ft_h->blocktable._current.blocknum_freelist_head.b};
    ...
    r = toku_deserialize_ftnode_from(
        fd, make_blocknum(1), 0 /*pass zero for hash*/, &dn, &ndd2, &bfe); 
...
int test_main(int argc __attribute__((__unused__)),
    ...
    initialize_dummymsn();
    test_serialize_nonleaf_two(valsize, nelts, entropy, ser_runs, deser_runs, 10);
